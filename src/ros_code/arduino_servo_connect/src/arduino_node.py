...
"""
  ...
  History:
    ...
    20181130: 新增可以直接发送命令控制舵机移动的函数moveServo,同时还新增
       使能和禁用舵机的函数enableServoByID和disableServoByID.
    20181205: 新增两个service，可以获取所有舵机的当前使能状态和位置信息.
    20181206: 新增topic可以获取arduino固件代码版本号,默认发布频率是10s发送一次.
       新增dynamic_reconfigure动态配置节点参数的功能.
"""
